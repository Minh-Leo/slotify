...
if (!isset($_POST['oldPassword']) || !isset($_POST['newPassword1']) || !isset($_POST['newPassword2'])) {
    echo "Please fill in all the passwords fields";
    exit();
}
...
if (preg_match('/[^A-Za-z0-9]/', $newPassword1)) {
    echo "New password can only contain letters and/or numbers";
    exit();
}

if (strlen($newPassword1) > 30 || strlen($newPassword1) < 5) {
    echo "New password must be between 5 and 30 characters";
    exit();
}
